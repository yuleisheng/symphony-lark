defmodule SymphonyElixir.TestSupport do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      alias SymphonyElixir.Tracker.Task, as: Issue
      ...
      setup do
        ...
        workflow_file = Path.join(workflow_root, "WORKFLOW.lark.md")
        ...
        on_exit(fn ->
          ...
          Application.delete_env(:symphony_elixir, :lark_client_module)
  ...
  defp workflow_content(overrides) do
    ...
    tracker_app_id = Keyword.get(config, :tracker_app_id, Keyword.get(config, :tracker_api_token))
    tracker_app_secret = Keyword.get(config, :tracker_app_secret, "app-secret")
    tracker_tasklist_guid = Keyword.get(config, :tracker_tasklist_guid, "tasklist-guid")
    tracker_endpoint = Keyword.get(config, :tracker_endpoint)
    tracker_state_field_name = Keyword.get(config, :tracker_state_field_name, "Status")
    ...
    tracker_complete_terminal_tasks = Keyword.get(config, :tracker_complete_terminal_tasks, true)
    ...
    sections =
      [
        ...
        "  app_id: #{yaml_value(tracker_app_id)}",
        "  app_secret: #{yaml_value(tracker_app_secret)}",
        "  tasklist_guid: #{yaml_value(tracker_tasklist_guid)}",
        "  state_field_name: #{yaml_value(tracker_state_field_name)}",
        ...
        "  complete_terminal_tasks: #{yaml_value(tracker_complete_terminal_tasks)}",
        "polling:",
