defmodule SymphonyElixir.CLITest do
  ...
  test "returns the guardrails acknowledgement banner when the flag is missing" do
    ...
    assert {:error, banner} = CLI.evaluate(["WORKFLOW.lark.md"], deps)
  ...
  test "defaults to WORKFLOW.lark.md when workflow path is missing" do
    deps = %{
      file_regular?: fn path -> Path.basename(path) == "WORKFLOW.lark.md" end,
  ...
  test "uses an explicit workflow path override when provided" do
    parent = self()
    workflow_path = "tmp/custom/WORKFLOW.lark.md"
  ...
  test "accepts --logs-root and passes an expanded root to runtime deps" do
    ...
    assert :ok = CLI.evaluate([@ack_flag, "--logs-root", "tmp/custom-logs", "WORKFLOW.lark.md"], deps)
  ...
  test "returns ok when workflow exists and app starts" do
    ...
    assert :ok = CLI.evaluate([@ack_flag, "WORKFLOW.lark.md"], deps)
  end
end
