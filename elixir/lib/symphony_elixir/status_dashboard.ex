defmodule SymphonyElixir.StatusDashboard do
  ...
  defp format_project_link_lines do
    ...
    tasklist_part =
      case tracker.tasklist_guid do
        tasklist_guid when is_binary(tasklist_guid) and tasklist_guid != "" ->
          colorize(tasklist_guid, @ansi_cyan)

        _ ->
          colorize("n/a", @ansi_gray)
      end

    tasklist_line = colorize("│ Tasklist: ", @ansi_bold) <> tasklist_part
    state_field_line = colorize("│ State Field: ", @ansi_bold) <> colorize(tracker.state_field_name || "n/a", @ansi_cyan)
    ...
    case dashboard_url() do
      ...
      _ ->
        [tasklist_line, state_field_line]
    end
  end
