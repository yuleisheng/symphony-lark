defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Tracker do
    ...
    embedded_schema do
      field(:endpoint, :string, default: "https://open.larksuite.com")
      field(:app_id, :string)
      field(:app_secret, :string)
      field(:tasklist_guid, :string)
      field(:state_field_name, :string, default: "Status")
  ...
  defp finalize_settings(settings) do
    tracker = %{
      settings.tracker
      | app_id: resolve_secret_setting(settings.tracker.app_id, System.get_env("LARK_APP_ID")),
        app_secret: resolve_secret_setting(settings.tracker.app_secret, System.get_env("LARK_APP_SECRET")),
        tasklist_guid: resolve_secret_setting(settings.tracker.tasklist_guid, System.get_env("LARK_TASKLIST_GUID"))
    }
